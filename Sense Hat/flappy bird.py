...
col_color = (255,0,0)      # RGB color of column pixels
bg_color = (255,255,255)         # RGB color of background pixels
bird_color = (0,0,255)   # RGB color of the bird pixel
...
while True:
  ...
  if game_over:
    ...
    score = len(columns) - 2
    sense.show_message(str(score) + "Your point", text_colour=(255,0,0))
