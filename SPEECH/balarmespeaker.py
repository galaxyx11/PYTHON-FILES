...
# speech thanks to espeak api : sudo apt install espeak 
...
def run_detector():
		...
		# wait for detection
		print ("      ",yellb,bluet,"  SYSTEM ARMED   ",whitblac, "\n")
		print (yellb,bluet,"  WAITING FOR SENSOR DETECTION   ",whitblac, "\n")
		blue.on()
		red.off()
		os.system("espeak -a200 -s140 'Warning system is armed'")
		pir.wait_for_motion()
		blue.off()
		...
		sleep(1)
		buzzer.off()
		os.system("espeak -a200 -s150 'warning Intruder detected'") 
		red.on()
		takepic()
		sleep(1)
		takevid()
...
def load_lcd():
	# Remember 1602 sentences 16 characters 2004 20 charachters long!
      ...
      os.system("espeak -a200 -s150 'stop pictures taken and logged'") 
      sleep (5)
      display.lcd_clear()  
