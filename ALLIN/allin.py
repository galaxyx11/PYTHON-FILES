...
print("      " + "\033[0;37;44m" + " ALSO USING ANSI CODES FOR COLOURS " + "\033[1;37;40m" + "\n")
...
for i in range (1,2):
	...
	display.lcd_display_string(str(datetime.now().time()), 2) # Write text to second line of display
	sleep(3)
