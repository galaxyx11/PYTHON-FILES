...
try:
    while True:
        print("      ",blue,"UltraSonic Measurement in Progress",black,"\n")
        inchs = round(int(sensor1.distance*100) /2.54)# convert for inches
        feet = int(inchs / 12) # convert to feet
        remainder = (inchs % 12) # get remaining inches
        print(" Distance =",int(sensor1.distance * 100),"Cms","or",inchs,"Inches","or",feet,"Feet",remainder,"inches","\n\n\n")
        time.sleep(2)
